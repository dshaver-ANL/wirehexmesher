...
%           pause
         ...
         bound_in(i,1)=bound_out(i,1)-((Do-Di)/2.0)*cos(angle_p);
         bound_in(i,2)=bound_out(i,2)-((Do-Di)/2.0)*sin(angle_p);
...
%          if(af1<0);af1=af1+2*pi;end
          factor2=(af1-th)-1.5;

          if(factor2>2);factor2=factor2-2*pi;end
          if(factor2<-2);factor2=factor2+2*pi;end
          if(factor2>1); factor2=1; end
          if(factor2<0); factor2=0; end
          
          factor2=0;
          
          bin_x = bound_out(i,1)+((Do-Di)/(4.0-2*factor2))*cos(af1);
          bin_y = bound_out(i,2)+((Do-Di)/(4.0-2*factor2))*sin(af1);
...
%          if(af2>2*pi);af2=(af2-2*pi);end
          ...
          factor2=0;
           ...
           bin_x = bound_out(i,1)+((Do-Di)/(4.0-2*factor2))*cos(af2);
           bin_y = bound_out(i,2)+((Do-Di)/(4.0-2*factor2))*sin(af2);
